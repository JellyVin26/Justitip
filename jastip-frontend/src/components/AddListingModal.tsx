...
export default function AddListingModal({ isOpen, onClose, onSuccess, preSelectedTripId }: AddListingModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
      <div className="glass-panel rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh] border-none">
          ...
          <form id="add-listing-form" onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea 
                ...
                className="w-full px-4 py-3 bg-white/50 border border-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-accent focus:bg-white transition-all text-sm h-20 resize-none shadow-sm"
              ></textarea>
            </div>
          </form>
        </div>
        ...
        <div className="p-6 border-t border-gray-200/50 bg-white/50 flex justify-end gap-3">
          ...
          <button 
            ...
            className="px-6 py-2.5 text-sm font-bold bg-gradient-to-r from-brand-navy to-gray-800 text-white rounded-lg transition-all active-press shadow-premium disabled:opacity-70 disabled:cursor-not-allowed flex items-center gap-2"
          >
